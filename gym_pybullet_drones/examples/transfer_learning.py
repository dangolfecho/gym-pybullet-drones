...
In a terminal, run as:
    Using policy which has already been trained on 1 scenario and trying to
    apply on other scenarios

    $ python transfer_learning.py --schedule_path <path> 
...
DEFAULT_OUTPUT_FOLDER = 'results/transfer'
DEFAULT_MODEL_FOLDER = 'results'
DEFAULT_COLAB = False
...
def modified_run(schedule_path=DEFAULT_SC, multiagent=DEFAULT_MA, output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, colab=DEFAULT_COLAB, record_video=DEFAULT_RECORD_VIDEO, local=True):
    ...
    for config in schedule:
        ...
        model_path = os.path.join(DEFAULT_MODEL_FOLDER,
                                'save-'+'x'+'0.0'+'y'+'0.0'+'z'+'1.0'+'r'+'0.0'+'p'+'0.0'+'y'+'0.0')
        ...
        model = PPO.load(model_path+'/best_model.zip', train_env, verbose=1)
